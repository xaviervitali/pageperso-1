...
<section >
    ...
    <form method="POST">
        ...
        <textarea name="message" id="message" placeholder="" id="message" rows="10" required></textarea>

        <button class="btn " type="submit" id="submit" style="margin-top:20px;">Envoyer</b utton>
    </form>

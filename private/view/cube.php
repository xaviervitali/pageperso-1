    ...
    <article class="container">
        <div id="cube">
            <div class="face bottom" data-face="html">
                <img style="display:cover; width:100%" src="assets/img/htmlCssJs.png" alt="logo HTML/CSS/Javascript" />
            </div>
            ...
            <div class="face left" data-face="wordpress">
            ...
            <div class="face front" data-face="jquery" style="background-color:white;text-align: center;  margin: auto; opacity: 1;">
                <img src="assets/img/cordova.png" alt="logo Cordova" />
                </span>
            </div>
